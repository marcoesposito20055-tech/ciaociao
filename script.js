...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Hai questo talento speciale", "riuscire a farmi sentire una persona cosi fortunata"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
    ...
    if(frameNumber >= 2750 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Grazie perchè con te posso essere stanco, scemo, pensieroso, ma mi sento sempre a casa", "Sei la mia persona preferita,quella con cui voglio condividere tutto"], canvas.width / 2, (canvas.height/2 + 60), fontSize, lineHeight);
        } else {
            context.fillText("Grazie perchè con te posso essere stanco, scemo, pensieroso, ma mi sento sempre a casa", "Sei la mia persona preferita,quella con cui voglio condividere tutto!", canvas.width/2, (canvas.height/2 + 50));
        }
